...
<?php
    ...
    <form class="my-4 d-flex justify-content-between input-form">
        ...
        <div class="input-group flex-nowrap quantitiy-space">
            <input id="quantity" type="number" class="form-control" placeholder="Enter the quantity"
                aria-describedby="addon-wrapping" min="0" name="quantity" >
