...
class Sales extends Controller
{
        ...
        */
        ...
        {
              //the user can reach this page just if have 'transaction:read', 'transaction:update' permissions   
            $this->permissions(['transaction:read', 'transaction:update']);
            //self::check_if_empty($_POST['items_id']);
            //self::check_if_empty($_POST['quantity']);

            //protect the $_POST from xss attacks
            $this->htmlspecial($_POST);

            //make instance of model Tranaction to have info that i need from database
            $transaction = new Transaction();

            //update the Transaction in database
            $transaction->update($_POST);

            //after update the transaction will redirect the user to single transaction page
