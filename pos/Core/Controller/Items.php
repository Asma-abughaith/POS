...
class Items extends Controller
{
    ...
    public function store()
    {
        ...
        //now i want to assign value for $_POST['total_procurement'] 
        $_POST['total_procurement']=$_POST['quantity']*$_POST['cost'];
    ...
    public function update()
    {
        ...
        //i need to update the all procurment that i have because it's should be comulative
        $old_procurement=$selected->total_procurement;
        $_POST['total_procurement']=$_POST['quantity']*$_POST['cost']+$old_procurement;
    ...
    /**
     * Updates the image of item becuse we put form for image only
     *
     * @return void
     */
    public function image()
    {
       //the user can see this page just if have 'item:read', 'item:update' permission
        ...
        //redirect the use to item single page that i update it
        Helper::redirect('/item?id=' . $_POST['id']);
